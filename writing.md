  ...
  <section class="section">
    ...
    <div class="card-grid">
      ...
      <article class="card">
        ...
        <p>This paper examines the causal effect of electing a female Gram Panchayat (GP) president on public employment provision under the Mahatma Gandhi National Rural Employment Guarantee Scheme (MGNREGS). <em>Under Review (Journal of Development Economics)</em></p>
      </article>
    </div>
  </section>
