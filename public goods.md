    ...
    <table class="table table-striped mt-3">
      ...
      <tbody>
        <tr>
          ...
          <td>One-stop package for consistent string encoding, ID management, and label tracking across Stata datasets.</td>
          <td><a href="https://github.com/vijayshree-jayaraman/naam" target="_blank">GitHub</a></td>
        </tr>
        <tr>
